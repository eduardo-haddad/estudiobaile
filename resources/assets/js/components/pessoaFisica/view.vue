<template v-if="this.pessoa">
    ...
    <div id="container_conteudo" class="formulario" :class="{ loading: !item_carregado, loaded: item_carregado }">
        ...
        <editbar origin="pf" :edit="mostraPreview" export="false" delete="true" link="/export"></editbar>
        ...
        <div v-if="mostraPreview" class="container_preview">
            ...
            <div class="dados">
                ...
                <div class="valor" v-if="pessoa.nome">
                    <span class="campo">Nome</span>
                    <span class="texto">{{ pessoa.nome }}</span>
                    <br>
                </div>

                <div class="valor" v-if="pessoa.nome_adotado">
                    <span class="campo">Nome adotado</span>
                    <span class="texto">{{ pessoa.nome_adotado }}</span>
                    <br>
                </div>

                <div class="valor genero" v-if="genero">
                    <span class="campo">Gênero</span>
                    <span class="texto">{{ genero }}</span>
                    <br>
                </div>

                <div class="valor" v-if="estado_civil">
                    <span class="campo">Estado civil</span>
                    <span class="texto">{{ estado_civil }}</span>
                    <br>
                </div>

                <div class="valor" v-if="dt_nascimento">
                    <span class="campo">Nascimento</span>
                    <span class="texto">{{ dt_nascimento }}</span>
                    <br>
                </div>

                <div class="valor" v-if="pais_origem || pessoa.origem_cidade">
                    <span class="campo">Origem</span>
                    <span class="texto" v-if="pessoa.origem_cidade">{{ pessoa.origem_cidade }}</span><span class="texto" v-if="pais_origem && pessoa.origem_cidade">, </span><span class="texto" v-if="pais_origem">{{ pais_origem }}</span>
                    <br>
                </div>

                <div class="valor" v-if="pais_vive_em || pessoa.vive_em_cidade">
                    <span class="campo">Vive em</span>
                    <span class="texto" v-if="pessoa.vive_em_cidade">{{ pessoa.vive_em_cidade }}</span><span class="texto" v-if="pais_vive_em && pessoa.vive_em_cidade">, </span><span class="texto" v-if="pais_vive_em">{{ pais_vive_em }}</span>
                    <br>
                </div>
            </div>
            ...
            <!--DOCUMENTOS-->
            <br><br><br>
            <div class="dados" v-if="pessoa.rg || pessoa.cpf || pessoa.passaporte || pessoa.website || pessoa.cnpj || pessoa.razao_social">
                ...
                <div class="valor" v-if="pessoa.cpf">
                    <span class="campo">CPF</span>
                    <span class="texto">{{ pessoa.cpf }}</span>
                </div><br>

                <div class="valor" v-if="pessoa.passaporte">
                    <span class="campo">Passaporte</span>
                    <span class="texto">{{ pessoa.passaporte }}</span>
                </div>
                ...
                <div class="valor" v-if="pessoa.cnpj">
            ...
            <!-- CONTATOS -->
            <div class="dados" v-if="emails.length !== 0 || telefones.length !== 0">
                <br><br><br>
            ...
            <div id="projetos_pf" class="valor" v-if="pessoas_juridicas_relacionadas.length !== 0">
                <br><br><br>
            ...
            <div class="dados">
                ...
                <div class="valor genero">
                    ...
                    <!--<input-->
                            ...
                            <!--name="pessoa.genero"-->
                            <!--placeholder=" " />-->
                    <select name="generos" class="generos_lista" v-model="pessoa.genero">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            eventBus.$on('editbar-editar-pf', () => {
                this.editaForm();
            });
            //evento - salvar formulário
            eventBus.$on('editbar-salvar-pf', () => {
                this.salvaForm();
            });
            //evento - mostrar modal de exclusão
            eventBus.$on('editbar-excluir-pf', () => {
            ...
            //evento - exportar
            eventBus.$on('editbar-exportar-pf', () => {
                this.exportar();
            });
        ...
        methods: {
            ...
            getPessoa: function(id){
                ...
                axios.get('/ajax/pf/' + id)
                    .then(res => {
                        ...
                        this.pais_vive_em = dados.pais_vive_em;
            ...
            jQuery: function(){
                ...
                $(document).ready(function(){
                    ...
                    $('.generos_lista').val(Vue.pessoa.genero).trigger('change');
                    $('.origem_paises_lista').val(Vue.pessoa.origem_pais_id).trigger('change');
                    $('.vive_em_paises_lista').val(Vue.pessoa.vive_em_pais_id).trigger('change');
