...
@component('site.components.carousel')
  ...
  <div id="carouselProjetoWrap" class="carousel slide" data-ride="carousel">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-fix-3">
        <div class="notas">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae, necessitatibus.</p>
          <p>Debitis itaque sed odio error eos, adipisci temporibus nobis ipsum!</p>
          <p>Laborum debitis recusandae non fugit mollitia. Error qui quo accusamus.</p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col">
        <div class="galeria">
          ...
          <div class="thumb portrait pb-2">
            <img src={{ asset('/images/galeria1/RM1.png') }}>
          </div>
          <div class="thumb portrait pr-1 pb-2">
            <img src={{ asset('/images/galeria1/RM4.jpg') }}>
          </div>
          <div class="thumb landscape pb-2">
